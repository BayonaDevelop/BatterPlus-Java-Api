package com.bayonasoftware.batteryplus.api.commons.infrastructure.controllers;
...
public class AddressController {
  ...
  private final IAddressUseCases addressService;

  public AddressController(final IAddressUseCases addressService) {
